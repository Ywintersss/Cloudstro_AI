        ...
        <main className="flex flex-col min-h-screen">
          ...
          <div className="pb-12 px-4 flex flex-col justify-center items-center min-h-screen">
            ...
            <p className="text-xl text-center text-gray-600 mb-12 max-w-2xl leading-relaxed">
              Boost your social media presence with AI-powered tools that
              transform your content strategy and maximize engagement.
            </p>
            <Link
              href="/signup"
              className="px-8 py-4 bg-blue-600 text-white rounded-lg text-lg font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg"
            >
              Start Boosting Now
            </Link>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-12">
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Generate engaging posts with AI that understands your brand
                ...
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Optimize posting times using machine learning to reach your
                    audience when they're most active.
                  </p>
                </div>
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                  ...
                  <p className="text-gray-600">
                    Deep insights into engagement patterns, hashtag performance,
            ...
            <div className="max-w-4xl mx-auto px-8 text-center">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Our AI algorithms analyze millions of successful posts to
                ...
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Automate your content creation, scheduling, and engagement
                    monitoring while maintaining authentic brand voice across
                    all platforms.
                  </p>
                </div>
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  ...
                  <p className="text-gray-600">
                    Manage Instagram, Twitter, LinkedIn, and Facebook from one
                    dashboard with platform-specific optimization for each post.
                  </p>
                </div>
                <div className="bg-gray-50 p-8 rounded-xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-2 shadow-md">
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">
                  ...
                  <p className="text-gray-600">
                    Monitor your performance with live analytics, trend
                    detection, and actionable recommendations to improve your
                    strategy.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl transform hover:scale-105 transition-all duration-300 shadow-md">
                  <p className="text-gray-700 text-lg italic mb-6">
                    "SocialHeat AI transformed my social media game. My engagement
                    rates doubled in just 30 days, and I'm saving hours every
                    week on content planning."
                  </p>
                ...
                <div className="bg-gray-50 p-8 rounded-xl transform hover:scale-105 transition-all duration-300 shadow-md">
                  <p className="text-gray-700 text-lg italic mb-6">
                    "The AI-generated content feels authentic and on-brand. It's
                    like having a social media expert working 24/7 for my
                    business."
                  </p>
                  <div className="flex items-center justify-center">
                    <div>
          ...
          <section className="pt-20 relative min-h-screen flex items-center justify-center bg-white shadow-lg">
            <div className="max-w-3xl mx-auto px-8 text-center">
              ...
              <p className="text-xl text-gray-600 mb-12 leading-relaxed">
                Join thousands of creators and businesses who are already seeing
                incredible results with SocialHeat AI.
              </p>
              <div className="space-y-4 md:space-y-0 md:space-x-6 md:flex md:justify-center">
                <Link
                  href="/signup"
                  className="w-full md:w-auto px-10 py-4 bg-blue-600 text-white rounded-lg text-lg font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg"
                >
                  Start Free Trial
                </Link>
              </div>
